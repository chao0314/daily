...
//
//         memo[key] = type(instance[key] ?? el.getAttribute(`virtual-infinite-scroll-${key}`) ?? defaultVal);
//
//         return memo;
//
//
...
//
//
// const WVirtualInfiniteScroll: ObjectDirective<InfiniteScrollEl, InfiniteScrollCallback> = {
//
...
// }
//
// export default WVirtualInfiniteScroll;
//
