class Heap {
    ...
    topToDownHeapify() {
        ...
        while (parentIndex <= this.index) {
            ...
            if (childIndex <= this.index && this.compare(this.store[parentIndex], this.store[childIndex]) > 0) index = childIndex;
            // 两个子节点都大/小  选最后一个
...
hp1.buildHeap([4, 1, 3, 2]);
console.log(hp1.store)
// console.log(hp1.sort());
